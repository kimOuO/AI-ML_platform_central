...
echo ""
echo "##############################################################"
echo "Build ai_ml_oom-ai_ml_mt_connector :"
echo ""

export BACKEND_IMAGE_NAME=140.118.162.95/prod/pipeline-operation
export BACKEND_CONTAINER_NAME=aiml_ai_ml_mt_connector
...
docker run \
    ...
    -p ${AI_ML_MT_CONNECTOR_CONTAINER_PORT}:8000 \
    -v ${PWD}/../Environmental_Variables/.env.common:${CONTAINER_WORKDIR}/.env.common \
    -itd ${BACKEND_IMAGE_NAME}:${AI_ML_MT_CONNECTOR_API_VERSION} \
