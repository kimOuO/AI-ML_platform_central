...
export BACKEND_IMAGE_NAME=140.118.162.95/prod/agent-operation
export BACKEND_CONTAINER_NAME=aiml_agent_connector
...
docker run \
    ...
    -p ${AGENT_CONNECTOR_CONTAINER_PORT}:8000 \
    -v ${PWD}/../Environmental_Variables/.env.common:${CONTAINER_WORKDIR}/.env.common \
    -itd ${BACKEND_IMAGE_NAME}:${AGENT_CONNECTOR_API_VERSION} \
