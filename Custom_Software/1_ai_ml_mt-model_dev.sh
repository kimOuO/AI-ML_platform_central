...
env_vars["HTTP_METADATA_MGT_HOST_IP"]=${CENTRAL_HOST_IP}
env_vars["HTTP_METADATA_MGT_PORT"]=${AUTHENTICATE_MIDDLEWARE_CONTAINER_PORT}
env_vars["HTTP_METADATA_MGT_VERSION"]=${AUTHENTICATE_MIDDLEWARE_API_VERSION}
...
docker run \
    ...
    -itd ${BACKEND_IMAGE_NAME}:${MODEL_DEV_API_VERSION}\
